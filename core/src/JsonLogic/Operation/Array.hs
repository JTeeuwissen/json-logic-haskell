...
-- Evaluation for map
evaluateMap :: Monad m => SubEvaluator m -> Rule -> Data -> ExceptT String m Json
...
evaluateReduce :: Monad m => Function m
...
evaluateFilter :: Monad m => Function m
...
evaluateArrayToBool :: Monad m => ([Bool] -> Bool) -> SubEvaluator m -> Rule -> Data -> ExceptT String m Json
...
evaluateMerge :: Monad m => Function m
